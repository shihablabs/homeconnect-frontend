...
import { BarChart3, TrendingUp, Users, Building, DollarSign, Calendar, Download, Loader2 } from 'lucide-react';
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-32 h-2 bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${
                                  stats.usersByRole?.tenant && stats.totalUsers
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-32 h-2 bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${
                                  stats.usersByRole?.landlord && stats.totalUsers
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-32 h-2 bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${
                                  stats.usersByRole?.admin && stats.totalUsers
                        ...
                        <div className="flex items-center gap-2">
                          <div className="w-32 h-2 bg-muted rounded-full overflow-hidden">
                            <div
                              ...
                              style={{
                                width: `${
                                  stats.usersByRole?.support && stats.totalUsers
